...
void MainWindow::sourceFound(unsigned int samplerate, int channels, QString device) {
...
void MainWindow::encoderFound(QString server, QString name, QString pass, QString genre, QString url, int pub, unsigned int samplerate, int bitrate, int channels) {
